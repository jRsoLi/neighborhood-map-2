...
function initMap() {
    var mapOptions = {
        zoom: 14,
        center: new google.maps.LatLng(53.550022, 9.98556),
    ...
    // Search function
    sightsModel.search = ko.computed(function() {
        var self = this;
    ...
    sightsModel.filteredMarkers = ko.computed(function() {
        var search = this.query().toLowerCase();
...
function gError() {
    document.getElementById("map-canvas").innerHTML = "<h2> Could not find the map you are looking for... </h2>";
}
